...
<meta charset="utf-8" />
<link rel="stylesheet" media="all" type="text/css" href="../../Styles/jquery-ui-1.8.16.custom.css" />
...
<!--
	  ...
	  <link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/dojo/1.10.2/dijit/themes/tundra/tundra.css">
	  <link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/dojo/1.10.2/dijit/themes/nihilo/nihilo.css">
	  <link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/dojo/1.10.2/dijit/themes/soria/soria.css">
      -->
<link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/dojo/1.10.2/dijit/themes/claro/claro.css" />
<link rel="stylesheet" type="text/css" href="./js/Styles/CANVAS.css" />
<link rel="stylesheet" type="text/css" href="./js/Styles/d3.geneBrowser.css" />

<script type="text/javascript" src="./bower_components/d3/d3.min.js" charset="utf-8"></script>
<script type="text/javascript" src="./bower_components/colorbrewer/colorbrewer.js" charset="utf-8"></script>
<script type="text/javascript" src="./bower_components/jquery/dist/jquery.min.js"></script>
<script type="text/javascript" src="./bower_components/dijit/dijit.js"></script>
<script type="text/javascript" src="./js/jquery.tipsy.js"></script>
<script type="text/javascript" src="./js/ErrorDisplay/ErrorDisplay.js"></script>
<script type="text/javascript" src="./js/Demographics/Demographics.js"></script>
<script type="text/javascript" src="./js/VariantSelection/VariantSelection.js"></script>
<script type="text/javascript" src="./js/VariantSelection/d3.variantTable.js"></script>
<script type="text/javascript" src="./js/VariantSelection/d3.variantList.js"></script>
<script type="text/javascript" src="./js/VariantSelection/d3.variantScatterPlot.js"></script>
<script type="text/javascript" src="./js/VariantSelection/d3.variantLegend.js"></script>
<script type="text/javascript" src="./js/Genome/Genome.js"></script>
<script type="text/javascript" src="./js/Genome/d3.genomeBrowser.js"></script>
<script type="text/javascript" src="./js/Genome/d3.geneBrowser.js"></script>
<script type="text/javascript" src="./js/DecisionSupport/DecisionSupport.js"></script>
<script type="text/javascript" src="./js/Provenance/Provenance.js"></script>
<script type="text/javascript" src="./js/Context/Context.js"></script>
<script type="text/javascript" src="./js/Utils/AjaxUtil.js"></script>
<script type="text/javascript" src="./js/Globals/DataDepot.js"></script>
...
<script type="text/javascript" src="./bower_components/dojo/dojo.js" data-dojo-config="async: true"></script>
...
<body class="claro">
  <div data-dojo-type="dijit/layout/BorderContainer" data-dojo-props="liveSplitters:true" id="OuterContainer"
    ...
    <div data-dojo-type="dijit/layout/BorderContainer" data-dojo-props="region:'center', style:{border:'none'}">
      <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'top', splitter:true, style:{border:'none'}"
        style="height: 40%">
          ...
          <div data-dojo-type="dijit/layout/BorderContainer" title="Gene browser" data-dojo-props="style:{border:'none'}">
            <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'top'" style="height: 75px;">
              <div>
                ...
                <div id="GeneHeightSlider" style="width: 200px; margin-bottom: -15px; display: inline-block"
                  data-dojo-type="dijit/form/HorizontalSlider"
                  data-dojo-props="minimum:10, maximum:50, intermediateChanges:true, showButtons:false">Gene height</div>
                <div id="CollapsibleScaleSlider" style="width: 200px; margin-bottom: -15px; display: inline-block"
                  data-dojo-type="dijit/form/HorizontalSlider"
                  data-dojo-props="minimum:0, maximum:100, intermediateChanges:true, showButtons:false">Intron scale</div>
                <div id="IntronBorderSlider" style="width: 200px; margin-bottom: -15px; display: inline-block"
                  data-dojo-type="dijit/form/HorizontalSlider"
                  data-dojo-props="minimum:2, maximum:100, intermediateChanges:true, showButtons:false">Intron border</div>
                <div id="VariantSizeSlider" style="width: 200px; margin-bottom: -15px; display: inline-block"
                  data-dojo-type="dijit/form/HorizontalSlider"
              ...
              <div style="margin-top: 10px;">
                ...
                <div id="TranscriptHeightSlider" style="width: 200px; margin-bottom: -15px; display: inline-block"
                  data-dojo-type="dijit/form/HorizontalSlider"
                  data-dojo-props="minimum:10, maximum:25, intermediateChanges:true, showButtons:false">Transcript height</div>
                <div id="TranscriptSpacingSlider" style="width: 200px; margin-bottom: -15px; display: inline-block"
                  data-dojo-type="dijit/form/HorizontalSlider"
                  data-dojo-props="minimum:0, maximum:25, intermediateChanges:true, showButtons:false">Transcript spacing</div>
                <div id="FeatureOpacitySlider" style="width: 200px; margin-bottom: -15px; display: inline-block"
                  data-dojo-type="dijit/form/HorizontalSlider"
      ...
      <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'center', splitter:true, style:{border:'none'}"
        style="height: 100%">
            ...
            <div data-dojo-type="dijit/layout/ContentPane" title="Supporting evidence" style="width: 99%" id="DecisionSupportingEvidenceTab">
              <div style="width: 1000px; margin-left: auto; margin-right: auto">
                ...
                <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'middle'" style="margin-top: -10px;"
                  id="DecisionSupportRuleApplication"></div>
                <div data-dojo-type="dijit/layout/ContentPane" data-dojo-props="region:'bottom'" style="margin-top: -10px;"
                  id="DecisionSupportDataEntry"></div>
              </div>
            </div>
          </div>
        </div>
