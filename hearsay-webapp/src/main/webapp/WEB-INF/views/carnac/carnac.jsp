...
<script type="text/javascript">
  ...
  function(ready, parser, aspect, registry) {
    ready(function() {
      // get the donor code
      var donorCode = '${participantName}';
      var participantJSON = '${participantJSON}';
      ...
      var demographics = renderDemographics(donorCode, participantJSON, demographicsPane.domNode);
