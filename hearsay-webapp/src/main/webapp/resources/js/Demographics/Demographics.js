...
function renderDemographicData(dataSet)
{
	...
	else
	{
		...
		var textArea = demographics.append("text")
		    .attr("fill", "black");
	    ...
	    textArea
	    	.append("tspan")
		    	...
		    	.text("Participant: " + dataSet.DONOR_CODE);
	    ...
	    textArea
	    	.append("tspan")
		    	...
		    	.text("Gender: " + dataSet.Gender + ", Diagnostic Lists: " + dataSet.DxListNames + ", Incidental Lists: " + dataSet.IncidentalListNames);
	}
}
