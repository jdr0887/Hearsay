...
function renderProvenance(donorCode, container) {
  ...
  c.append("svg").attr("id", "provenance")
  ...
  var textArea = provenance.append("text").attr("x", 50).attr("y", 50).attr("fill", "black").attr("font-family", "Arial Black").attr(
      "font-size", "14").attr("font-style", "italic").text("Provenance Selection area");
}
