...
/**
 * <p>
 * Java class for Invalidation complex type.
 * 
 * <p>
...
@XmlType(name = "Invalidation", propOrder = { "entity", "activity", "time", "label", "location", "role", "type", "any" })
...
public class Invalidation extends Element {
    ...
    @OneToMany(mappedBy = "invalidation", fetch = FetchType.EAGER, cascade = { CascadeType.PERSIST, CascadeType.MERGE })
    ...
    public String toString() {
        return String.format("Invalidation [primaryKey=%s, id=%s, entity=%s, activity=%s, time=%s]", primaryKey, id,
