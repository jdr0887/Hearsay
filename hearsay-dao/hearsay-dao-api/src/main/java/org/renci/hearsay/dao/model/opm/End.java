...
@XmlType(name = "End", propOrder = { "activity", "trigger", "ender", "time", "label", "location", "role", "type", "any" })
...
public class End extends Element {
    ...
    @OneToMany(mappedBy = "end", fetch = FetchType.EAGER, cascade = { CascadeType.PERSIST, CascadeType.MERGE })
