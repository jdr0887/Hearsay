...
@XmlType(name = "Usage", propOrder = { "activity", "entity", "time", "label", "location", "role", "type", "any" })
@javax.persistence.Entity
@Table(name = "opm_usage")
public class Usage extends Element {
    ...
    @OneToMany(mappedBy = "usage", fetch = FetchType.EAGER, cascade = { CascadeType.PERSIST, CascadeType.MERGE })
