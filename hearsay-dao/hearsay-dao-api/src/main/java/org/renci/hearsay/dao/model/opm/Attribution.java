...
/**
 * <p>
 * Java class for Attribution complex type.
 * 
 * <p>
...
@XmlType(name = "Attribution", propOrder = { "entity", "agent", "label", "type", "any" })
...
public class Attribution extends Element {
    ...
    @OneToMany(mappedBy = "attribution", fetch = FetchType.EAGER, cascade = { CascadeType.PERSIST, CascadeType.MERGE })
    ...
    public String toString() {
        return String.format("Attribution [primaryKey=%s, id=%s, entity=%s, agent=%s]", primaryKey, id, entity, agent);
    }
